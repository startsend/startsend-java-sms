...
/**
    Class to send sms through StartSend sms/viber/voice service
    Compilating using command line:  javac -cp $CLASSPATH StartSendSample.java
*/
...
class StartSend
{
    ...
    //  private String API_URL = "https://app.startsend.ru/api/v1/";
  ...
  */
   ...
   * Метод-обёртка для команды getAlphaNames ?
     ...
     Пример ответа: {"0":"Системное имя (Startsend)","1363":"VasheImya"}
   */
